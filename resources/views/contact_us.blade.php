    ...
    <section class="signup container">
        ...
        <div class="form-list">
            <form  method="post" novalidate>
                ...
                <div class="input-fill-x">
                    <input type="text" class="input-control input-fill" name="question"  value="{{old('question')}}"  placeholder="Question" required>
                    <label class="input-label label-require">Question</label>
                    <div class="error" @error('question') style="display: block;" @enderror > @error('question') {{$message}} @enderror </div>
                </div>
                <div class="form-item">
                    <input type="checkbox" name="is_like_receive" {{old('is_like_receive') === 1 ? 'checked' : ''}}  value="1" class="form-checkbox"> <span class="form-checkbox-txt">I would like to receive updates about UTU (optional)</span>
                </div>
                <div class="form-txt">
